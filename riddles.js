...
new class MapRiddle extends EasyRiddle {
    constructor() { super("Surely even a brute like you can solve this! I have cities, but no houses. I have mountains, but no trees. I have water, but no fish. What am I? ️", ["map", "maps"], ["Oh, Wesley, think about the charts you must have used on your ship.", "He's speaking of a representation of the world, not the world itself.", "It can be folded and carried with you on a great adventure."]); }
}(),
new class NeedleRiddle extends EasyRiddle {
    constructor() { super("A simpleton's query! What has an eye, but cannot see? 👁️", ["needle", "nedle", "nedel"], ["It's something my mother used for sewing, to mend clothes.", "Think of something small and sharp, with a single hole for thread to pass through.", "Even the finest dress might need one of these after a tussle."]); }
}(),
